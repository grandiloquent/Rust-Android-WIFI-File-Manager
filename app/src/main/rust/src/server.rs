...
pub async fn run_server(srv: Server, db: Database, ass: AssetManager) {
    ...
    let mut server = rocket::custom(figment)
        ...
        .mount("/",
               routes![handlers::api_article::api_articles,handlers::api_article::api_article,handlers::api_article::api_article_update,handlers::api_asset_file::api_asset_file,handlers::api_file::api_file,handlers::api_file::api_file_post,handlers::api_files::api_files,handlers::api_files::api_files_clear,handlers::api_files::api_files_rename,handlers::api_file_delete::api_file_delete,handlers::api_file_new::api_file_new_file,handlers::api_file_new::api_file_new_dir,handlers::api_file_rename::api_file_rename,handlers::api_file_rename::api_file_move,handlers::api_zip::api_zip,handlers::compress_zip::compress_zip,handlers::db::get_notes,handlers::db::search_notes,handlers::db::like_notes,handlers::db::insert_note,handlers::db::append_note,handlers::db::get_snippet,handlers::db::insert_snippet,handlers::db::delete_snippet,handlers::db::get_statistics,handlers::db::insert_statistics,handlers::editor::editor,handlers::editor::editor_file,handlers::file::file,handlers::index::index,handlers::index_file::index_file,handlers::markdown::markdown,handlers::markdown::markdown_file,handlers::notes::get_notes_page,handlers::subtitle::subtitle,handlers::title::title,handlers::translate::trans,handlers::upload::upload,handlers::video::video])
